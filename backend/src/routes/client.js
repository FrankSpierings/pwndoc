module.exports = function (app) {
    ...
    app.put("/api/clients/:id", acl.hasPermission('clients:update'), function (req, res) {
        var client = {};
        // Optional parameters
        if (req.body.email) client.email = String(req.body.email);
        client.lastname = String(req.body.lastname) || null;
        client.firstname = String(req.body.firstname) || null;
        client.phone = String(req.body.phone) || null;
        client.cell = String(req.body.cell) || null;
        client.title = String(req.body.title) || null;
        var company = null;
        if (req.body.company && req.body.company.name) company = String(req.body.company.name);
